...
- (void)setupMainView
{
    ...
    UICollectionView *mainView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, rect.size.width, rect.size.height) collectionViewLayout:flowLayout];
...
- (void)setFrame:(CGRect)frame
{
    ...
    _flowLayout.itemSize = rect.size;
}
...
- (void)layoutSubviews
{
    ...
    _mainView.frame = CGRectMake(0, 0, rect.size.width, rect.size.height);
